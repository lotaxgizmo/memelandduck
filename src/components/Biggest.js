...
function Biggest() {
  return (
    <>
    <div  className='h-24 bgd-red-500 border-black border-y-[1px] flex flex-col justify-center items-center'>
    <Marquee direction='right'> <img src={BigMobile} alt="" className='w-52s'/> </Marquee>
</div>
